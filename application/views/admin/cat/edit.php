            <div id="content" class="flex ">
                ...
                <div>
					...
					<form method="POST" action="/admin/ajax/cat/edit/<?=$category['id']?>" class="ajax-form">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="name" name="name" placeholder="Название" value="<?=$category['name']?>" required>
											</div>
											<div class="form-group">
												<label class="text-muted" for="channels">Каналы</label>
													...
													<?php foreach($channels as $k=>$v){ ?>
														<option value='<?=$v['id']?>' <?=($v['category'] != 0 AND $v['category'] != $category['id']) ? 'disabled' : ''?> <?=($v['category'] == $category['id']) ? 'selected' : ''?> ><?=$v['name']?></option>
													<?php } ?>
                                                    </select>
											</div>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <label class="ui-switch ui-switch-md info m-t-xs">
                                                        <input name="adult" id="adult" type="checkbox" <?=($category['adult']) ? 'checked' : ''?>>
                                                        <i></i>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                        <input type="text"  name="pincode" class="form-control" maxlength="4" value="<?=$category['pincode']?>" id="pin" pattern="\d{4}" placeholder="Только 4 цифры" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
                                                </div>
                                            </div>
