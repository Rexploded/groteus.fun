            ...
            <img src="<?=$USER['avatar']?>" alt=".">
                                    ...
                                    <div class="p-4" id="c_2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="editemail" class="form-control" value="<?=$USER['email']?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min='0' step="1" value="<?=$USER['ban_long']?>" name="ban_long" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Причина бана:</label>
                                                <textarea rows="3" name="ban_reason" class="form-control"><?=$USER['ban_reason']?></textarea>
                                            </div>
											<hr>
											<div class="form-group">
                                                        <label class="md-check">
                                    ...
                                    <div class="p-4" id="c_3">
											...
											<div class="form-group">
                                                        <label class="md-check">
                                                            <input name="disable_change_country" type="checkbox" <?=($USER['disable_change_country']) ? 'checked' : ''?>>
                                                            <i class="red"></i>
                                                            Запретить смену страны
                                                        </label>
											</div>
                                            <div class="form-group">
                                                <label>Сервер</label>
											...
											<div class="form-group">
                                                        <label class="md-check">
                                                            <input name="disable_change_server" type="checkbox" <?=($USER['disable_change_server']) ? 'checked' : ''?>>
                                                            <i class="red"></i>
                                                            Запретить смену сервера
                                                        </label>
											</div>
                                    </div>
                                    ...
                                    <div class="p-4" id="c_4">
											<div class="form-group">
                                                        <label class="md-check">
                                                            <input name="refferals_success" onchange="RefferalsChange(this)" value='1' type="radio" <?=($USER['refferals_success'] == 1) ? 'checked' : ''?>>
                                                            <i class="blue"></i>
                                                            Общие условия <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-info" data-toggle="popover" data-trigger="hover" data-html="true" data-content="Простое участие в партнерской программе."><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="8"></line></svg>
                                                        </label>
											</div>
											<div class="form-group">
                                                        <label class="md-check">
                                                            <input name="refferals_success" onchange="RefferalsChange(this)" value='0' type="radio" <?=($USER['refferals_success'] == 0) ? 'checked' : ''?>>
                                                            <i class="red"></i>
											...
											<div class="form-group">
                                                        <label class="md-check">
                                                            <input name="refferals_success" onchange="RefferalsChange(this)" value='2' type="radio" <?=($USER['refferals_success'] == 2) ? 'checked' : ''?>>
                                                            <i class="green"></i>
								...
								<div class="p-5" id="refrules" style="<?=($USER['refferals_success'] != 2) ? 'display:none;' : ''?>">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover v-middle">
										...
										<?php foreach($this->billing->GetReferralsRulesForUser(false,$USER['id']) as $k=>$v){ ?>
                                                ...
                                                <td>
                                                    <div class="item-action dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right bg-black" role="menu">
                                                            <a class="dropdown-item" style="<?=($v['status'] == 1) ? '' : 'display:none'?>" onclick="GetMass('/admin/ajax/billing/referrals/users/action/','off','<?=$v['id']?>');$(this).closest('.v-middle').addClass('table-warning');$(this).next().show();$(this).hide();">
                                                                Деактивировать
                                                            </a>
                                                            <a class="dropdown-item" style="<?=($v['status'] == 0) ? '' : 'display:none'?>" onclick="GetMass('/admin/ajax/billing/referrals/users/action/','on','<?=$v['id']?>');$(this).closest('.v-middle').removeClass('table-warning');$(this).prev().show();$(this).hide();">
                                                                Активировать
                                                            </a>
                                                            <div class="dropdown-divider"></div>
                                                            <a  onclick="GetMass('/admin/ajax/billing/referrals/users/action/','delete','<?=$v['id']?>');$(this).closest('.v-middle').slideUp();" class="dropdown-item trash">
                                                                Удалить
                                                            </a>
                                                        </div>
                                                    </div>
...
function SessionDelete(id,reload=false){
	$.get( "/admin/ajax/users/session/delete/<?=$USER['id']?>/"+id+"?{csrf_name}={csrf_value}", function( data ) {
