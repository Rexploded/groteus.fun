            <div id="content" class="flex ">
                ...
                <div>
					...
					<form method="POST" action="/admin/ajax/news/create" class="ajax-form">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="title" name="title" placeholder="Название" value="" required>
											</div>
												
											<div class="form-group">
												<label class="text-muted" for="text">Новость</label>
												<textarea class="form-control" rows="8" id="text" name="text"  data-plugin="summernote" data-option="{minHeight: 150}"></textarea>
											</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
										...
										<?php foreach($this->system->get_lang_list() as $k=>$v){ ?>
											<option value="<?=$v['SYMBOL']?>" ><?=$v['NAME']?></option>
										<?php } ?>
                                        </select>
                                                </div>
                                            </div>
										...
										<?php } ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
													<input type="text" class="form-control" name="users" value="" placeholder="Всем">
                                                </div>
                                            </div>
...
<hr>
										...
										<?php } ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
													<input type="text" class="form-control" name="not_users" value="" placeholder="Никому">
                                                </div>
                                            </div>
