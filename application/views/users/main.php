                ...
                <div class="flex">
                                                ...
                                                <div class="pt-2">
                                                    <div class="nav-fold px-2">
                                                        <a class="d-flex p-2" data-toggle="dropdown">
                                                            ...
                                                            <img src="[profile:avatar]" alt="..." class="w-40 r">
                                                        </a>
                    ...
                    <div class="nav-active-text-primary" data-nav>
                        <ul class="nav bg">
                            ...
                            <li class="nav-header hidden-folded">
                                <span class="text-muted">Финансы</span>
                            </li>						

                            <li>
                                <a href="/tariffs">
                                    <span class="nav-icon text-primary"><i data-feather='home'></i></span>
                                    <span class="nav-text">Пополнить</span>
                                </a>
                            </li>
							<li>
                                <a href="/history">
							...
							[YES Users Referrals Access]
							<li>
                                <a href="/tariffs">
                                    <span class="nav-icon text-primary"><i data-feather='home'></i></span>
                                    <span class="nav-text">Рефералка</span>
                                </a>
                            </li>
							[/YES Users Referrals Access]
							<li>
                                <a href="/tariffs">
                                    <span class="nav-icon text-primary"><i data-feather='home'></i></span>
                                    <span class="nav-text">Вывод средств</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-header hidden-folded">
                                <span class="text-muted">Тарифы и услуги</span>
                            </li>
                            ...
                            <li>
                                <a href="/services">
                                    <span class="nav-icon text-primary"><i data-feather='home'></i></span>
                                    <span class="nav-text">Мои подписки
										<span class="item-amount badge badge-pill red" style="float: right;">2</span>
										<span class="item-amount badge badge-pill gd-success br-1" style="float: right;margin-right: 2px;">1</span>
									</span>
                                </a>
                            </li>
...
<div class="py-2 mt-2 b-t no-shrink">
                    ...
                    <ul class="nav navbar-menu order-1 order-lg-2">
                                            <li class="nav-item dropdown">
                                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
													<?=$this->system->get_lang_list()[$_SESSION['language']]['NAME']?>
                                                </a>
                        ...
                        <li class="nav-item dropdown">
                                            <a href="#" data-toggle="dropdown" class="nav-link d-flex align-items-center px-2 text-color">
                                                <span class=" mx-2 d-none l-h-1x d-lg-block text-right">[profile:username]</span>
                                                <span class="avatar w-24" style="margin: -2px;"><img src="[profile:avatar]" alt="..."></span>
                                            </a>
        ...
        <!-- lazyload plugin -->
        <script src="/assets/js/lazyload.config.js?v=35"></script>
